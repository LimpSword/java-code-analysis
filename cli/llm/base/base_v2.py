...
class LLMBase:
    ...
    def get_complete_prompt_size(self, prompt, schema=None):
        schema_prompt = ""
    ...
    def get_size_without_prompt(self, schema=None):
        schema_prompt = ""
    ...
    def divide_prompt(self, prompt, schema=None) -> list[str]:
        prompt_len = self.get_complete_prompt_size(prompt, schema)

        subprompts = []

        encoded_prompt = codecs.encode(prompt, "tiktoken")
